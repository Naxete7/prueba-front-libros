          ...
          <Row className="d-flex flex-wrap flex-direction-row bookStyle">
            ...
            <Col className="d-flex flex-wrap flex-direction-row bookStyle">
              ...
              <h6>
                ...
                change over time. This practical, hands-on guide takes you
                through the theory and tools you need to build evolvable HTTP
                services with Microsoft’s ASP.NET Web API framework. In the
                process, you’ll learn how design and implement a real-world Web
                API.
              </h6>
              <h6>
